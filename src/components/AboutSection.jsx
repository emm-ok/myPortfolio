      ...
      <div className='container mx-auto max-w-5xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
          <div className='space-y-6'>
            ...
            <p className='text-muted-foreground'>With over 2 years of experience in web development,
              I specialize in creating responsive, accesible,
          ...
          <div className='grid grid-cols-1 gap-6'>
            <div className='gradient-border shadow-md p-6 card-hover'>
              <div className='flex items-start gap-4'>
                ...
                <div className='text-left'>
                  ...
                  <p className='text-muted-foreground'>
                    Creating reponsive websites and 
            ...
            <div className='gradient-border shadow-md p-6 card-hover'>
              <div className='flex items-start gap-4'>
                ...
                <div className='text-left'>
                  <h4 className='font-semibold text-lg'>UI/UX Deign</h4>
                  <p className='text-muted-foreground'>
